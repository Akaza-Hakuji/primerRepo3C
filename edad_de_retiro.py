...
edad_actual = int(input()) # int () convierte texto en número entero, es decir sin decimales
# 5. Preguntar al usuario '¿A qué edad te quieres retirar?'
print('¿A qué edad te quieres retirar?')
...
# 8. Hacer año_de_retiro - anio_actual + anios_para_retiroanio
anios_de_retiro = anio_actual + anios_para_retiro
...
# 10. Mostrar mensaje ' Es el año' anio_actual 'entonces te podrás retirar en' anio_de_retiro
print('Es el año', anio_actual, 'entonces, te podrás retirar en', anios_de_retiro)
