...
# 1. Inicio
# 2. Definir ancho, largo, área_metros, área_pies, factor_conversión.
# 3.  Hacer factor_conversión = 10.764
...
largo = float(input()) # convertir a número
# 6. Imprimir "¿Cuál es el ancho del cuarto en metros?"
print ("¿Cuál es el ancho del cuarto en metros?")
# 7. Hacer ancho = entrada del usuario
ancho = float(input())
# 8. Hacer area_metros = largo * ancho
area_metros = largo * ancho
# 9. Hacer area_pies = factor_conversión * area_metros
